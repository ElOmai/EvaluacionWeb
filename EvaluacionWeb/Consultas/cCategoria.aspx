<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCategoria.aspx.cs" Inherits="EvaluacionWeb.Consultas.cCategoria" %>
                                ...
                                <asp:GridView ID="DatosGridView"
                                    ...
                                    <Columns>
                                        <asp:HyperLinkField ControlStyle-CssClass="btn btn-info"
                                            ...
                                            DataNavigateUrlFormatString="~/Registros/rCategorias.aspx?CategoriaId={0}"
